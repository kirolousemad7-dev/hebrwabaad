...
class PlatformSettingService
{
    ...
    public const DEFAULTS = [
        ...
        'homepage' => [
            ...
            'hero_subheading' => 'وكالة إبداعية تجمع البرمجة، التسويق، الهوية، الطباعة، التغليف وتنظيم الفعاليات في مسار واحد واضح من الفكرة حتى التنفيذ.',
        ...
        'seo' => [
            ...
            'default_meta_description' => 'حبر وأبعاد وكالة متكاملة تقدم خدمات البرمجة وتطوير المواقع، التسويق الرقمي، التصميم والهوية البصرية، الطباعة والتغليف وتنظيم الفعاليات من الفكرة حتى التنفيذ.',
