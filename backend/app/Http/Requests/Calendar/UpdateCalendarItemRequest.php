...
class UpdateCalendarItemRequest extends ApiFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', 'required', 'string', Rule::in(CalendarItemType::values())],
            'status' => ['sometimes', 'required', 'string', Rule::in(CalendarItemStatus::values())],
            'priority' => ['sometimes', 'required', 'string', Rule::in(CalendarItemPriority::values())],
            'visibility' => ['sometimes', 'required', 'string', Rule::in(CalendarVisibility::values())],
            'source' => ['sometimes', 'required', 'string', Rule::in(CalendarSource::values())],
