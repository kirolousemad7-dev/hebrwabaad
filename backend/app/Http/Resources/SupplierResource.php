...
class SupplierResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'address' => $this->when($this->show_public_contact === true, $this->address),
            'category' => $this->category,
            'years_experience' => $this->years_experience,
            'min_order_info' => $this->min_order_info,
            'brand_colors' => $this->brand_colors,
            'brand_description' => $this->brand_description,
            'phone' => $this->when($this->show_public_contact === true, $this->phone),
            'email' => $this->when($this->show_public_contact === true, $this->email),
            'website' => $this->when($this->show_public_contact === true, $this->website),
